...
1. Download the package suitable for your Operating System [here](https://github.com/MauricioPinguim/comics2video/releases)
2. Extract the file and open the executable file: ![comics2video](./docs/images/comics2video_executable.png)
...
## Developer usage: Node.js source-code
